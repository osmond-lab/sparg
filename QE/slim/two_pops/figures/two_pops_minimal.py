...
#    random_seed=9292#6334 #7483,8131
#)

#sample_locs = np.linspace(0, 1, ts.num_individuals)

#locations = {}
#for id,loc in enumerate(sample_locs):
#    locations[id] = [loc]
...
dispersal_rate, cov_mat, paths, locations_of_nodes, variances_in_node_locations = sparg.estimate_minimal_spatial_parameters(
    ts=ts_filtered,
    verbose=True,
    return_ancestral_node_positions=from_nine_nodes
)
