...
plt.errorbar(locations, ranks, xerr=confidence_interval, ecolor=within_95, label="estimated", fmt="none", zorder=1)
plt.scatter(true_locations, ranks, color=within_95, label="truth", zorder=2)
plt.xlim(0,100)
plt.xlabel("Location (x-dimension)")
