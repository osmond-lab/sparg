...
if __name__ == "__main__":    
    ...
    # d3arg = tskit_arg_visualizer.D3ARG(ts=ts_sim)
    # d3arg.draw(
    #     width=750,
    #     height=750,
    #     y_axis_labels=True,
    ...
    ts_final1, maps_final = ts_to_ARG(ts_sim)
    # d3arg = tskit_arg_visualizer.D3ARG(ts=ts_final1)
    # d3arg.draw(
    #     width=750,
    #     height=750,
    #     y_axis_labels=True,
    ...
    ts_final1 = ts_final1.decapitate(time=1000)
    
    ts_final = merge_roots(ts_final1)
    d3arg = tskit_arg_visualizer.D3ARG(ts=ts_final)
    d3arg.draw(
        width=750,
        height=750,
        y_axis_labels=True,
