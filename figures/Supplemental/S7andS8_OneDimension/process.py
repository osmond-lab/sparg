...
center_of_samples = np.mean(x_locations)

# convert tree sequence to a SpatialARG
spatial_arg = sparg.SpatialARG(ts=ts_chopped, verbose=True, dimensions=1)


# reset the dispersal rate matrix to the theoretical value
spatial_arg.dispersal_rate_matrix = np.array([[0.25*0.25+0.5,0]])
...
random_ancestors["true_dist_to_center"] = abs(random_ancestors["true_location_0"] - center_of_samples)
...
random_ancestors["midpoint_abs_error"] = random_ancestors["midpoint_abs_error_0"]
random_ancestors["midpoint_dist_to_center"] = abs(random_ancestors["midpoint_estimated_location_0"] - center_of_samples)
...
random_ancestors["arg_abs_error"] = random_ancestors["arg_abs_error_0"]
random_ancestors["arg_dist_to_center"] = abs(random_ancestors["arg_estimated_location_0"] - center_of_samples)
...
random_ancestors["window_0_abs_error"] = random_ancestors["window_0_abs_error_0"]
random_ancestors["window_0_dist_to_center"] = abs(random_ancestors["window_0_estimated_location_0"] - center_of_samples)
random_ancestors.to_csv("random_ancestors_1000_effective_dispersal.csv")
print("W0 - Complete")
...
random_ancestors["window_100_abs_error"] = random_ancestors["window_100_abs_error_0"]
random_ancestors["window_100_dist_to_center"] = abs(random_ancestors["window_100_estimated_location_0"] - center_of_samples)
random_ancestors.to_csv("random_ancestors_1000_effective_dispersal.csv")
print("W100 - Complete")