...
benchmark_file = open("benchmarking.csv", "w")
benchmark_file.write("num_samples,sequence_length,seed,num_trees,nodes,paths,algo_order,paths_time,hybrid_r_time,hybrid_nr_time,paths_sum,hybrid_r_sum,hybrid_nr_sum\n")
...
for samples in range(10,110,10):
    ...
    for seq_len in range(1000, 6000, 1000):
        for repeat in range(10):
            ...
            benchmark_file.write(str(paths_bench[0]) + "," + str(hybrid_r_bench[0]) + "," + str(hybrid_nr_bench[0]) + "," + str(paths_bench[1]) + "," + str(hybrid_r_bench[1]) + "," + str(hybrid_nr_bench[1]) + "\n")
