...
if __name__ == "__main__":    
    ...
    random.seed(5)
    ts = msprime.sim_ancestry(samples=100, recombination_rate=1e-4, sequence_length=2_000, population_size=10_000, record_full_arg=True)
    keep_nodes = list(np.random.choice(ts.samples(), 30, replace=False))
    ...
    ts_final, maps, recomb_nodes= ts_to_ARG(ts_sim)
